...
export function SideNav() {
  return (
    <div className="w-64 border-r min-h-screen bg-primary text-primary-foreground p-4 flex flex-col">
      <div className="flex items-center justify-center mb-8">
        ...
        <div className="ml-3">
          ...
          <p className="text-xs opacity-75">ASO Dashboard</p>
        </div>
      </div>
      
      {/* Removed redundant navigation links */}
      <div className="flex-1">
        <div className="text-xs opacity-75 mt-2 mb-4 px-2">
          SuperOne Fan Battle - iOS
        </div>
      </div>
      
      <div className="mt-auto pt-4 border-t border-primary-foreground/20 flex items-center justify-between">
